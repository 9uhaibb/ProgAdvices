...
public:
    ...
    clsProgrammer (int ID, string FirstName, string LastName, string Email, string Phone,string Title,
...
int main ()
{
    clsProgrammer Programmer1 (10, "Ahmad", "Salem", "s@g.com", "949494", "Programmer", "P", 5000, "c++");
    Programmer1.Print();
}