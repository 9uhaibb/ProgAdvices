...
public:
   ...
   void Print()
	...
	static string GetSystemDateString()
	{
		...
		return clsDate::DateToString( clsDate(Day, Month, Year));
	}
	...
	static string GetSysDateAndTimeString ()
	{
	...
	{
		return GetDifferenceInDays(DateOfBirth, clsDate::GetSystemDateString(), true);
	}
