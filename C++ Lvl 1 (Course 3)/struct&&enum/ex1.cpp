...
int main()
{
    ...
    cout << Person1.ContactInfo.Address.StreetName  << endl; //from struct & nasted struct
    cout << Person1.Gendor << endl; // from enum

    //after finish Person1 , u can also do the same with Person2, 3, 4 ,....
