...
namespace ArraysLib
{
    ...
    void FillArrayWithRandomNumbers(int arr[100], int &arrLength)
    {
        ...
        cin >> arrLength;
        for (int i = 0; i < arrLength; i++)
            arr[i] =OutPuts::RandomNumber(1, 100);
    }
    void FillArrayWithRandomNumbers(int arr[100], int arrLength)
    {
        for (int i = 0; i < arrLength; i++)
                              ...
                              int arrLength, int &arr2Lenght)
    {
        ...
        for (int i = 0; i < arrLength; i++)
        {
            ...
            if (MathLib::CheckPrime(arrSource[i]) == Prime)
            {
    ...
    void ShuffleArray(int arr[100], int arrLength)
    {
        for (int i = 0; i < arrLength; i++)
        {
            MathLib::SwapNumbers(arr[OutPuts::RandomNumber(1, arrLength) - 1],
                        arr[OutPuts::RandomNumber(1, arrLength) - 1]);
        }
    }
